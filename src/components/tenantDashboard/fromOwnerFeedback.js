...
const FromOwnerFeedBack=()=> {
    ...
    const mainList = () =>{
        ...
        axios
          .get(`${GetBaseUrl()}/getallfeedfortenant/${userDataObj._id}`, { headers: headers })
          .then((res) => {
...
<Sidebar />
<section style={{ position: "relative", left: "10%", width: '84vw',marginTop: '4%'}}>
  ...
  <div className="ml-4">
    <MaterialTable
      ...
      columns={[
        ...
        {
          title:"House Name",
          field:"propertyId.houseName",
        },
        {
          title:"Owner Name",
          field:"propertyId.ownerName",
        },
        {
              ...
              <Link
                to={{
                  ...
                  state: {
                    ...
                    propertyId:data&& data.propertyId&&data.propertyId._id
                  },
                }}
              >
              <FeedbackIcon />
...
export default FromOwnerFeedBack;