                ...
                { data.items.map( ( item, i )=>
                    <div key={ i } className="col-lg-3 col-sm-6">
                      <div className="single-feature">
                        <div className="thumb">
                        <img src={ publicUrl+item.image } alt="img" style={{height:"180px",width:"100%"}}/>
                        </div>
                        <div className="details">
                          <a href="#" className="feature-logo">
                            <img src={ publicUrl+"/assets/img/icons/l3.png" } alt={ imagealt } />
                          </a>
                          ...
                          <ul className="contact-list">
                            ...
                            <li><a className="btn btn-yellow" href="">View Details</a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
