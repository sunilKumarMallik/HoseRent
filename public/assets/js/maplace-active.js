  ...
  var LocsA = [
    {
      ...
      html: [
        ...
        '<h6 class="title"><a href="properties-details.html">Ahalya Hill Resort</a></h6>',
    ...
    },
    {
      ...
      html: [
        ...
        '<thumb><img src="/assets/img/feature/appoinmentq.jpg" alt="img"></thumb>',
        '<div class="details">',
        '<a href="#" class="feature-logo"><img src="/assets/img/icons/l3.png" alt="icons"></a>',
        '<p class="author"><i class="fa fa-user"></i> Vilma Jarvi By Redbrox</p>',
    ...
    },
    {
      ...
      html: [
        ...
        '<a href="#" class="feature-logo"><img src="/assets/img/icons/l3.png" alt="icons"></a>',
        '<p class="author"><i class="fa fa-user"></i> Vilma Jarvi By Redbrox</p>',
        '<h6 class="title"><a href="properties-details.html">Falcon Residency</a></h6>',
        '<h6 class="price">$350/mo</h6><del>$790/mo</del>',
        '<ul class="info-list">',
        '<li><i class="fa fa-bed"></i> 05 Bed</li>',
        '<li><i class="fa fa-bath"></i> 02 Bath</li>',
